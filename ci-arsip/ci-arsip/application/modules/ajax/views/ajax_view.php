	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span3">
				...
				<?php echo form_open('ajax/submit',array('id'=>'addform','class'=>'form form-vertical')); ?>
					...
					<div class="control-group">
							<?php echo form_label('Amount : ','Amount',array('class'=>'control-label')); ?>
							<div class="controls">
								<?php echo form_input('amount','','id="amount"'); ?>
							</div>
					</div>
