    ...
    $(document).ready(function(){
        ...
        oTable=$('#datatables').dataTable({
            ...
            "aoColumns": [
                ...
                { "sClass": "file_type", "sName": "file_type", "sWidth": "80px", "aTargets": [2] },
                { "sClass": "file_size", "sName": "file_size", "sWidth": "80px", "aTargets": [3] },
                { "sClass": "file_url", "sName": "file_url", "sWidth": "80px", "aTargets": [ 4 ] },
                { "sClass": "file_group", "sName": "file_group", "sWidth": "80px", "aTargets": [ 5 ] },
            ...
            e.preventDefault();
                ...
                if(confirm('Are You Sure?')){
                    $(this).ready(function(){
                        ...
                        $.ajax({
                            url: "<?php echo base_url()?>arsip/delete/",
                            type: 'POST',
                            data: del_data,
